...
| 9. Retained metadata privacy | Split count-only scans: local `marker 0`, `secret 0`, `paths 0`, `paths_logs 16`; mini-1 `0`, `0`, `162`, `66`; mini-2 `0`, `0`, `65`, `80`; mini-3 `0`, `0`, `3`, `52`. Marker/secret passed and the local `paths` count was zero; the worker `paths` criterion was not fully passed. Application-log path counts are reported separately. |
